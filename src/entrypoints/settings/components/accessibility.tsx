...
export interface AccessibilitySettingsProps {
  ...
  updatePendingAccessibilitySetting: (key: keyof WordServeSettings['accessibility'], value: any) => void;
}

export function AccessibilitySettings({ pendingSettings, updatePendingAccessibilitySetting }: AccessibilitySettingsProps) {
  return (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updatePendingAccessibilitySetting("uppercaseSuggestions", checked)
                }
              />
            </div>
            ...
            <div className="space-y-2 max-w-xs">
              ...
              <Select
                ...
                onValueChange={(value: "normal" | "muted" | "faint" | "accent") =>
                  updatePendingAccessibilitySetting("prefixColorIntensity", value)
                }
              >
            ...
            <div className="space-y-2 max-w-xs">
              ...
              <Select
                value={pendingSettings.ghostTextColorIntensity}
                onValueChange={(value: "normal" | "muted" | "faint" | "accent") =>
                  updatePendingAccessibilitySetting("ghostTextColorIntensity", value)
                }
              >
